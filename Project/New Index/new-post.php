...
<html lang="en">
  <head>
    <title>JobPortal - QReoTech.com</title>
    <meta charset="utf-8">
        ...
        <div class="row">
          ...
          <div class="col-md-12 col-lg-8 mb-5">
              ...
              <div class="col-md-12 mb-3 mb-md-0">
                            ...
                            <label class="font-weight-bold" for="fullname">Qualification</label>
			              					<div class="form-field">
				              					<div class="select-wrap">
						                      <div class="icon"></div>
						                      <select name="" id="" id="selQualif" class="form-control" required>
...
?>
                ...
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="fullname">No Of Vacancy</label>
                  <input type="text" id="fullname" name="txtVacancy" class="form-control" placeholder="eg. 100, 8000.">
                </div>
              </div>
              ...
              <div class="col-md-12 mb-3 mb-md-0">
                            ...
                            <label class="font-weight-bold" for="fullname">Experience</label>
			              					<div class="form-field">
				              					<div class="select-wrap">
						                      <div class="icon"></div>
						                      <select name="selExp" id="" class="form-control" required>
              ...
              <div class="col-md-12 mb-3 mb-md-0">
                            ...
                            <label class="font-weight-bold" for="fullname">Location</label>
			              					<div class="form-field">
				              					<div class="select-wrap">
						                      <div class="icon"></div>
						                      <select name="selLoc" id="" class="form-control" required>
...
?>
              ...
              <div class="row form-group">
                <div class="col-md-12" required><h3>Job Type</h3></div>
                <div class="col-md-12 mb-3 mb-md-0">
              ...
              <div class="row form-group">
                <div class="col-md-12"><label>LastDate</label></div>
                <div class="col-md-12 mb-3 mb-md-0">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <input type="submit" value="Post" name="btnsave" class="btn btn-primary  py-2 px-5">
                </div>
              </div>
