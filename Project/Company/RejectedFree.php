...
<h2><i>----Rejected List----</i></h2>
<br/><br/><br/><center>
<div class="container">
 <table class="table table-dark table-striped table-hover" id="tbl" style="width:500px;">
...
<?php    
          $i=0;        
		 $sel="select * from tbl_jobapply j inner join tbl_freelancer u on u.freelancer_id=j.freelancer_id where jobapply_status='2'";
