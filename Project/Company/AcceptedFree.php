...
<?php    
          $i=0;        
		 $sel="select * from tbl_jobapply a inner join tbl_freelancer u on u.freelancer_id=a.freelancer_id where jobapply_status='1' and company_id='".$_SESSION['companyid']."'";
...
?>
       ...
       <td>
        <a href="interviewDetailsFree.php?ivdid=<?php echo  $data['freelancer_id'];?>" style="color:#FFF;">Send&nbsp;details</a></td>
