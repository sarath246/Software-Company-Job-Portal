<?php
	   ...
	   if(isset($_POST['btnSave']))
	  {
		  ...
		  $ins="insert into tbl_usermsg(msg_date,msg_loc,msg_time,msg_sel,msg_venue,msg_ampm,company_id,user_id)values('".$Date."','".$Loc."','".$Time."','".$Sel."','".$Venue."','".$Select."','".$_SESSION['companyid']."','".$_GET['ivdid']."')";
		  echo $ins;
          mysql_query($ins,$con);
...
<form id="form1" name="form1" method="post" action="">
  <table width="582" height="876" border="0">
    ...
    <tr>
      <td height="158" style="text-align:center;">venues</td>
    ...
    <tr>
      <td>&nbsp;</td>
      <div class="container">
      <td><input class="button btn" type="submit" name="btnSave" id="btnSave" style="background-color:#063; color:#FFF;" value="Send" onclick="<script>alert('Message sended');"/></td></div>
    </tr>
  </table>
</form>
</center>
