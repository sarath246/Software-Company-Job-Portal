<?php
	 ...
	 {
		 $old=$_POST['txtpsw'];
		      $sel="select * from tbl_userregistration where user_id='".$_SESSION['userid']."' and 	user_password='$old'";
		   ...
		   if($NewPassword!=$ConPassword)
 			 {
				...
				{
         $upQuery= $update="update tbl_userregistration set user_password='$NewPassword' where user_id='".$_SESSION['userid']."'";
