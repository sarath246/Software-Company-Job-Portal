...
<table border="0" width="60%" height="100" class="w3-table w3-striped  w3-bordered">
...
?>
   ...
   <img src="../Company/Proof/<?php echo $datas['company_logo']; ?> " width="150px" height="20px"/></td>
    <td style="text-align:center;"><a href="FjobApply.php?jobvacid=<?php echo $datas['jobvacancy_id']; ?>">Details & apply</a></td>
   </tr>
<?php
  }
?>
