...
<?php
      $sel="select * from tbl_save s inner join  tbl_companyregistration c on c.company_id=s.company_id inner join tbl_qualification q on q.qualification_id=s.qualification_id inner join tbl_jobcategory j on
	   j.jobcategory_id=s.jobcategory_id inner join tbl_jobvacancy v on v.jobvacancy_id=s.jobvacancy_id  where freelancer_id='".$_SESSION['freelancerid']."'";
	  // echo $sel;
...
<td width="12%" style="text-align:center;"><a href="FJobApply.php?jobvacid=<?php echo  $data['jobvacancy_id'];?>">
